<?php
/**
 * Cache management for JSON-LD output.
 *
...
/**
 * Handles transient-based caching of JSON-LD output.
 */
final class Cache {
	 ...
	 *
	 * @param string $key    Cache key.
	 * @param string $output JSON-LD output.
	 * @return void
	 */
	...
	/**
	 * Generate a hash of current settings for cache key.
	 *
	 * @return string
	 */
