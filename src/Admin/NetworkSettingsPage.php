<?php
/**
 * Network settings page for JSON-LD plugin.
 *
...
/**
 * Renders and handles the network-level JSON-LD settings page.
 */
final class NetworkSettingsPage {
	...
	public function render(): void {
		...
		$settings = wp_parse_args(
			(array) get_site_option( Settings::NETWORK_OPTION_KEY, array() ),
					...
					<tr>
						...
						<td>
							<input type="text" id="org_name" name="soderlind_jsonld[org_name]"
								...
								placeholder="<?php echo esc_attr( get_network()->site_name ); ?>" class="regular-text" />
						</td>
					</tr>
					<tr>
						<th scope="row">
						...
						<td>
							<input type="url" id="org_logo" name="soderlind_jsonld[org_logo]"
								value="<?php echo esc_attr( $settings['org_logo'] ); ?>" class="regular-text"
								placeholder="https://" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" id="org_founding_date" name="soderlind_jsonld[org_founding_date]"
								value="<?php echo esc_attr( $settings['org_founding_date'] ); ?>" class="small-text"
								placeholder="YYYY" />
							<p class="description">
								<?php esc_html_e( 'Year (e.g., 2020) or full date (e.g., 2020-01-15).', 'soderlind-json-ld' ); ?>
							</p>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							?>
							<p class="description">
								<?php esc_html_e( 'Add social profile URLs (LinkedIn, Twitter/X, Facebook, GitHub, etc.).', 'soderlind-json-ld' ); ?>
							</p>
						</td>
					</tr>
				</table>
	...
	/**
	 * Handle the network settings save action.
	 *
	 * @return void
	 */
	public function handle_save(): void {
		...
		$input = isset( $_POST['soderlind_jsonld'] ) ? wp_unslash( $_POST['soderlind_jsonld'] ) : array();
